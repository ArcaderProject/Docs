...
Du kannst das Modell direkt hier interaktiv aus allen Winkeln betrachten – mit der Maus drehen, zoomen und auf dem Smartphone sogar per AR in deinen Raum stellen:

<model-viewer
  src="/assets/arcade_machine_wood_base.glb"
  ios-src="/assets/Arcade_Machine_Wood_Base.usdz"
  alt="Interaktives 3D-Modell des Arcade-Automaten Grundgerüsts"
  poster=""
  camera-controls
  auto-rotate
  ...
  shadow-intensity="1"
  style="width: 100%; height: 480px; background-color: #1e202a; border-radius: 4px; --poster-color: transparent;">
</model-viewer>

Alternativ kannst du dir das Modell auch auf <a href="https://sketchfab.com/3d-models/arcade-machine-wood-base-7800679fd0f54210a0e7d8027a0f3bdf" target="_blank">Sketchfab</a> ansehen.
...
![Schritt 1](/assets/pic_guide_1.png)
...
![Schritt 2](/assets/pic_guide_2.png)

### Schritt 3:
Hier wiederholst du quasi einfach noch mal Schritt 1 nur weiter oben.
![Schritt 3](/assets/pic_guide_3.png)

### Schritt 4:
Wenn du jetzt etwas an deinem Gestell wackelst, merkst du, dass es noch ziemlich nachgibt. Deshalb baust du jetzt einige diagonale Latten ein. Bevor du jetzt aber loslegst, scroll noch etwas nach unten und schau dir den [Tipp](/hardware/#tipp-schritt-4) an.
![Schritt 4](/assets/pic_guide_4.png)
### Tipp Schritt 4:
...
![Tipp Schritt 4](/assets/pic_guide_4.5.png)
...
![Schritt 5](/assets/pic_guide_5.png)
...
![Schritt 6](/assets/pic_guide_6.png)
...
![Schritt 7](/assets/pic_guide_7.png)
...
![Tipp Schritt 9](/assets/pic_guide_9.5.png)

### Schritt 10:
Bisher sind die beiden Teile ja lediglich durch die zwei Latten hinten verbunden. Das änderst du jetzt! Dafür setzt du zwei Latten wie gezeigt ein. Und für die Abschrägungen nicht vergessen, was du in [Tipp Schritt 4](/hardware/#tipp-schritt-4) gelernt hast.
![Schritt 10](/assets/pic_guide_10.png)
...
![Schritt 11](/assets/pic_guide_11.png)
...
![Button Panel Schritt 1](/assets/pic_guide_12.png)
...
![Button Panel Schritt 2](/assets/pic_guide_13.png)
...
![Button Panel Schritt 3](/assets/pic_guide_14.png)

### Schritt 4:
Als Letztes schraubst du einfach dein Panel an den Automaten und fertig.
![Button Panel Schritt 4](/assets/pic_guide_15.png)
...
![Verkleidung Schritt 1](/assets/pic_guide_16.png)
...
![Verkleidung Schritt 4](/assets/pic_guide_19.png)

### Schritt 5:
Hast du dich entschieden? Gut, dann weißt du warscheinlich schon was kommt: festschrauben.
![Verkleidung Schritt 5](/assets/pic_guide_20.png)
...
![Verkleidung Schritt 6](/assets/pic_guide_21.png)
...
![Verkleidung Schritt 7](/assets/pic_guide_22.png)

## Coin Acceptor
Solltest du vorhaben einen Münzschlitz einzubauen, ist dieser Abschnitt wichtig für dich. Ansonsten spring einfach zum [nächsten Abschnitt](/software/).
...
Gezeigt ist hier ein Arduino UNO, jedoch kannst du basically jeden beliebigen nehmen, nur musst du eventuell den Code anpassen.
...
Den Code für den arduino findest du [hier](https://github.com/ArcaderProject/Arcader/tree/main/coin-acceptor).
![Coin Acceptor Verkabelung](/assets/coin_acceptor_arduino_wiring.png)
